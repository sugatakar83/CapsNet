...
from CapsNetLayers import CapsuleLayer, PrimaryCap, Length, Mask
import warnings
...
def margin_loss(y_true, y_pred):
    """
    Margin loss for Eq.(4) from Hinton's paper
    """
...
def train(model, data, args):
    ...
    from CapsNetUtil import plot_log
...
def test(model, data):
    ...
    from CapsNetUtil import combine_images
